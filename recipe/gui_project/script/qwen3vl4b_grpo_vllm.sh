...
EXPERIMENT_NAME=${DATE}-qwen3_vl_4b_gta1_filtered_30000_grpo_with_attention_log
...
PYTHONUNBUFFERED=1 python -m verl.trainer.main_ppo \
    ...
    data.train_max_samples=30000 \
    data.val_batch_size=128 \
    data.dataloader_num_workers=0 \
    data.max_prompt_length=7168 \
    data.max_response_length=48 \
    ...
    custom_reward_function.compute_attention=True \
    ...
    actor_rollout_ref.rollout.max_num_batched_tokens=7216 \
    actor_rollout_ref.rollout.log_prob_micro_batch_size_per_gpu=16 \
    actor_rollout_ref.rollout.attention_micro_batch_size_per_gpu=12 \
